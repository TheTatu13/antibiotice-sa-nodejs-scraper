 ...
 * this is the check that would have caught docs/index.html referencing a
 * workflow name that had since been renamed. Deliberately does not hardcode
 * either name: what matters is that whatever files exist are named
 * descriptively and that every link in docs/index.html points at one of them.
 */
import fs from "fs";
